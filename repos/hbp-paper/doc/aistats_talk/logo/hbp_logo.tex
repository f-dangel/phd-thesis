  ...
  \node[text = anthrazit] {
    $\begin{pmatrix}
      \begin{tikzpicture}
        ...
        % blocks
        \node (block11background) [offdiagonal, minimum height = 18, minimum width = 18, matrix block] at (placeholder.south east) {};
        ...
        \node (block22background) [offdiagonal, minimum width = 12, minimum height = 12, matrix block] at (block12.south west) {};
        ...
        \node (block33background) [offdiagonal, minimum width = 6.8, minimum height = 6.8, matrix block] at (block23.south west) {};
        ...
        \node (block44background) [offdiagonal, minimum width = 8, minimum height = 8, matrix block] at (block34.south west) {};

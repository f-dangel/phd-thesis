\begin{figure}[!b]
  ...
  \begin{minipage}[t]{0.495\linewidth}
    ...
    \input{../../fig/exp02_gradient_curvature_overlap/fig_multiple_batches/GGN_0_grad_0_1/overlap_000000/Overlap.tex}
  \end{minipage}
  \begin{minipage}[t]{0.495\linewidth}
    \centering
    % customize "zmystyle" as you wish
    ...
    \input{../../fig/exp02_gradient_curvature_overlap/fig_multiple_batches/GGN_0_grad_0_1/overlap_000000/OverlapHistogram.tex}
  \end{minipage}
  \hfill
  ...
  \begin{minipage}[t]{0.495\linewidth}
    ...
    \input{../../fig/exp02_gradient_curvature_overlap/fig_multiple_batches/GGN_0_grad_0_1/overlap_000010/Overlap.tex}
  \end{minipage}
  \begin{minipage}[t]{0.495\linewidth}
    \centering
    % customize "zmystyle" as you wish
    ...
    \input{../../fig/exp02_gradient_curvature_overlap/fig_multiple_batches/GGN_0_grad_0_1/overlap_000010/OverlapHistogram.tex}
  \end{minipage}
  \hfill
  ...
  \begin{minipage}[t]{0.495\linewidth}
    ...
    \input{../../fig/exp02_gradient_curvature_overlap/fig_multiple_batches/GGN_0_grad_0_1/overlap_000200/Overlap.tex}
  \end{minipage}
  \begin{minipage}[t]{0.495\linewidth}
    \centering
    % customize "zmystyle" as you wish
    ...
    \input{../../fig/exp02_gradient_curvature_overlap/fig_multiple_batches/GGN_0_grad_0_1/overlap_000200/OverlapHistogram.tex}
  \end{minipage}
  \hfill
  \vspace{-2\baselineskip}

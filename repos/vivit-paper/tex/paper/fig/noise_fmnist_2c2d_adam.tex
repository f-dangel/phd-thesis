...
\begin{figure}[tb]
  ...
  \begin{minipage}[t]{0.33\linewidth}
    ...
    \input{../../fig/exp11_noise_monitoring/fig/lambdas_gammas_mean/fmnist_2c2d_Adam_epoch_00000_batch_00000.tex}
  \end{minipage}
  \hspace{2ex}
  \begin{minipage}[t]{0.33\linewidth}
    \centering
    ...
    \input{../../fig/exp11_noise_monitoring/fig/lambdas_gammas_mean/fmnist_2c2d_Adam_epoch_00000_batch_00100.tex}
  \end{minipage}
  \hspace{-3.5ex}
  \begin{minipage}[t]{0.33\linewidth}
    \centering
    ...
    \input{../../fig/exp11_noise_monitoring/fig/lambdas_gammas_mean/fmnist_2c2d_Adam_epoch_00056_batch_00000.tex}
  \end{minipage}
  \hspace{-2.5ex}
  ...
  \begin{minipage}[t]{0.33\linewidth}
    ...
    \input{../../fig/exp11_noise_monitoring/fig/gradient_curvature_overlap_hist/fmnist_2c2d_Adam_epoch_00000_batch_00000.tex}
  \end{minipage}
  \hspace{2ex}
  \begin{minipage}[t]{0.33\linewidth}
    \centering
    ...
    \input{../../fig/exp11_noise_monitoring/fig/gradient_curvature_overlap_hist/fmnist_2c2d_Adam_epoch_00000_batch_00100.tex}
  \end{minipage}
  \hspace{-3.5ex}
  \begin{minipage}[t]{0.33\linewidth}
    \centering
    ...
    \input{../../fig/exp11_noise_monitoring/fig/gradient_curvature_overlap_hist/fmnist_2c2d_Adam_epoch_00056_batch_00000.tex}
  \end{minipage}
  \hspace{-2.5ex}
  \hspace{0ex}
  ...
  \begin{minipage}[t]{0.33\linewidth}
    ...
    \input{../../fig/exp11_noise_monitoring/fig/lambdas_snr/fmnist_2c2d_Adam_epoch_00000_batch_00000.tex}
  \end{minipage}
  \hspace{2ex}
  \begin{minipage}[t]{0.33\linewidth}
    \centering
    ...
    \input{../../fig/exp11_noise_monitoring/fig/lambdas_snr/fmnist_2c2d_Adam_epoch_00000_batch_00100.tex}
  \end{minipage}
  \hspace{-3.5ex}
  \begin{minipage}[t]{0.33\linewidth}
    \centering
    ...
    \input{../../fig/exp11_noise_monitoring/fig/lambdas_snr/fmnist_2c2d_Adam_epoch_00056_batch_00000.tex}
  \end{minipage}
  \hspace{-2.5ex}
  ...
  \begin{minipage}[t]{0.33\linewidth}
    ...
    \input{../../fig/exp11_noise_monitoring/fig/gammas_snr/fmnist_2c2d_Adam_epoch_00000_batch_00000.tex}
  \end{minipage}
  \hspace{2ex}
  \begin{minipage}[t]{0.33\linewidth}
    \centering
    ...
    \input{../../fig/exp11_noise_monitoring/fig/gammas_snr/fmnist_2c2d_Adam_epoch_00000_batch_00100.tex}
  \end{minipage}
  \hspace{-3.5ex}
  \begin{minipage}[t]{0.33\linewidth}
    \centering
    ...
    \input{../../fig/exp11_noise_monitoring/fig/gammas_snr/fmnist_2c2d_Adam_epoch_00056_batch_00000.tex}
  \end{minipage}
  \hspace{-2.5ex}
  ...
  \caption{\textbf{Gradient, curvature and noise during training of \fmnist
      \twoctwod with \adam.} Individual columns show the architecture's state at
  ...
  \label{fig:noise-fmnist-2c2d-adam}
\end{figure}
